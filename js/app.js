(() => {
    ...
    function addLoadedClass() {
        window.addEventListener("load", (function() {
            const openWindow = document.querySelector(".britain__window");
            if (openWindow) setTimeout((() => {
    ...
    function initSliders() {
        if (document.querySelector(".blog-home__slider")) new core(".blog-home__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            lazy: true,
            navigation: {
                prevEl: ".blog-home-button-prev",
                nextEl: ".blog-home-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".services-home__inner")) {
            const thumbsSwiper = new core(".pictures-slider__slider", {
            ...
            new core(".info-slider__slider", {
                modules: [ Thumb, Pagination, Navigation, Parallax ],
                observer: true,
                watchOverflow: true,
                observeParents: true,
                parallax: true,
        ...
        if (document.querySelector(".item-cart__slider")) new core(".item-cart__slider", {
            ...
            effect: "fade",
            navigation: {
                prevEl: ".item-cart-prev",
                nextEl: ".item-cart-next"
            },
            on: {}
        });
    }
    ...
    da.init();
    if (document.querySelector(".britain__window")) window.addEventListener("load", (function() {
        const openWindow = document.querySelector(".britain__window");
        const linkClose = openWindow.querySelector(".window-britain__close");
    ...
    if (document.querySelector(".britain__submenu")) window.addEventListener("scroll", (function() {
        let mainElement = document.querySelector(".main-top__body");
        let mainElementPosition = mainElement.getBoundingClientRect().top + scrollY + mainElement.offsetHeight;
        let mainSubElement = document.querySelector(".submenu-main");
        if (pageYOffset >= mainElementPosition) mainSubElement.classList.add("active"); else mainSubElement.classList.remove("active");
    }));
    if (document.querySelector(".go-top")) {
        const goTop = document.querySelector(".go-top");
        window.addEventListener("scroll", (function() {
            if (pageYOffset.toFixed(0) >= 300) goTop.classList.add("active");
            if (pageYOffset.toFixed(0) < 300) goTop.classList.remove("active");
        }));
    }
    window["FLS"] = true;
    isWebp();
